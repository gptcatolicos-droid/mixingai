...
import { MixPreset } from './PresetScreen';
        ...
        <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',marginBottom:'16px',gap:'10px',flexWrap:'wrap'}}>
          <div>
            ...
            <p style={{color:'#9B7EC8',fontSize:'12px',marginTop:'4px'}}>
              ...
              {initialPreset && <span style={{marginLeft:'8px',background:initialPreset.id?'rgba(192,38,211,0.1)':'transparent',border:'1px solid rgba(192,38,211,0.25)',borderRadius:'980px',padding:'2px 8px',fontSize:'11px',color:'#C026D3',fontWeight:600}}>✦ {initialPreset.name}</span>}
            </p>
          </div>
