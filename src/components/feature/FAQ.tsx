...
const FAQ: React.FC<FAQProps> = ({ language }) => {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      questionEs: "¿Cómo obtengo mi mezcla gratis?",
      answer: "Simply create a free account and you get 1 free mix to start mixing your music. No payment required - just sign up and start creating professional mixes immediately.",
      answerEs: "Simplemente crea una cuenta gratuita y tienes 1 mezcla gratis incluida para comenzar a mezclar tu música. No se requiere pago - solo regístrate y comienza a crear mezclas profesionales inmediatamente.",
      category: "credits"
    },
    {
      ...
      answerEs: "El costo depende de la complejidad y duración de tu proyecto. Por $3.99 tienes mezclas ilimitadas. Tu mezcla gratis te permite probar la calidad del servicio sin compromiso.",
      category: "credits"
    },
    {
      ...
      <div className="text-center mt-12 p-8 bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl">
        ...
        <p className="text-gray-600 mb-6">
          {language === 'en'
            ...
            : 'Haz tu primera mezcla gratis y comienza a mezclar tu música profesionalmente hoy.'}
        </p>
        <button
