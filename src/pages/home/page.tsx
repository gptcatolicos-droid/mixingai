  ...
  return (
    <div style={S.page}>
      ...
      <section style={{position:'relative',overflow:'hidden',padding:'80px 24px 60px',textAlign:'center'}}>
        {/* Imagen de home studio tenue para posicionamiento de marca */}
        <div style={{position:'absolute',inset:0,backgroundImage:"url('https://images.unsplash.com/photo-1598653222000-6b7b7a552625?w=1400&q=80')",backgroundSize:'cover',backgroundPosition:'center top',opacity:0.08,pointerEvents:'none'}}></div>
        {/* Gradiente que preserva legibilidad */}
        <div style={{position:'absolute',inset:0,background:'linear-gradient(180deg,#0F0A1A 0%,rgba(15,10,26,0.55) 20%,rgba(15,10,26,0.55) 80%,#0F0A1A 100%)',pointerEvents:'none'}}></div>
