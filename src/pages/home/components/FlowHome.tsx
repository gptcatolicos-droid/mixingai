...
const CARDS = [
  {
    ...
    desc: 'Timeline · Mezcla · Generación IA · Stems',
    tags: ['Pro', 'Todas las funciones'],
    glyph: '✦', accent: T.fuchsia,
    cost: 'Sin coste por sesión',
  },
  {
    id: 'create',   t: 'Crear canción con IA',   s: 'Texto a música',
    desc: 'Genera una canción completa desde tu descripción',
    tags: ['Prompt', 'Letra', 'Referencia'],
    glyph: '♫', accent: T.pink,
    cost: '10 créditos',
  },
  {
    id: 'separate', t: 'Separar stems',           s: 'Demucs en navegador',
    desc: 'Sube una canción y obtén los stems al instante en el DAW',
    tags: ['Vocals', 'Drums', 'Bass', 'Other'],
    glyph: '✂', accent: T.violet,
    cost: '2 créditos',
  },
  {
    id: 'stems',    t: 'Cargar stems para mezcla', s: 'Mixer con presets',
    desc: 'Sube tus stems y aplica presets profesionales en el DAW',
    tags: ['Pop', 'Gospel', 'Reggaetón', '+9'],
    glyph: '↑', accent: T.amber,
    cost: 'Gratis',
  },
  {
    id: 'mixsong',  t: 'Mezclar canción',          s: 'Auto-mastering',
    desc: 'Sube una canción ya mezclada y la masterizamos',
    tags: ['LUFS', 'IA EQ', 'Limiter'],
