...
const MODES = [
  {
    ...
    desc: 'Sube hasta 12 stems (voz, batería, bajo, guitarra…). La IA los balancea, comprime y exporta listos para Spotify en WAV 24-bit.',
    badge: '1 crédito / mezcla',
    free: true,
  ...
  },
  {
    ...
    badge: '10 créditos / canción',
    free: true,
    preview: [0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2],
  },
  {
    id: 'stems',
    icon: '🎚️',
    ...
    badge: '3 créditos / separación',
    free: true,
    preview: [0.9,0.8,0.3,0.2,0.9,0.8,0.3,0.2,0.9,0.8,0.3,0.2,0.9,0.8,0.3,0.2],
  },
  {
    id: 'instruments',
    icon: '🎹',
    ...
    badge: '5 créditos / instrumento',
    free: true,
    preview: [0.5,0.6,0.7,0.8,0.9,0.8,0.7,0.8,0.9,0.8,0.7,0.6,0.7,0.8,0.7,0.6],
  },
];

// ─── Credits model ─────────────────────────────────────────────────────────
const CREDIT_ACTIONS = [
  { icon: '🎛️', action: 'Mezclar stems', cost: 1,  color: '#EC4899' },
  { icon: '✦',  action: 'Generar canción con IA', cost: 10, color: '#C026D3' },
  { icon: '🎚️', action: 'Separar stems', cost: 3,  color: '#7C3AED' },
  { icon: '🎹', action: 'Agregar instrumento IA', cost: 5,  color: '#a259ff' },
...
const PRO_FEATURES = [
  '✦ 1,000 créditos · nunca vencen',
  '🎛️ Mezclar stems — 1 crédito c/u',
  '✦ Generar canciones IA — 10 créditos c/u',
  '🎚️ Separar stems — 3 créditos c/u',
  '🎹 Agregar instrumentos — 5 créditos c/u',
...
const STATS = [
  ...
  { num:'$5.99', label:'1,000 créditos sin vencimiento', icon:'∞' },
];
...
const FAQ_ITEMS = [
  ...
  { q:'¿Cómo funcionan los créditos?', a:'Los créditos son la moneda de MixingMusic.AI. Cada acción tiene un costo: mezclar stems cuesta 1 crédito, generar una canción con IA cuesta 10, separar stems cuesta 3, agregar un instrumento cuesta 5, y exportar WAV cuesta 1. Con $5.99 obtienes 1,000 créditos que nunca vencen.' },
    ...
    <div style={{ minHeight:'100vh', color:T.text, fontFamily:"'Outfit',system-ui,sans-serif" }}>
      ...
      <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'100px 20px 60px', textAlign:'center', position:'relative' }}>
        ...
        <div style={{ display:'flex', gap:'14px', flexWrap:'wrap', justifyContent:'center', marginBottom:'60px' }}>
          <button onClick={goRegister} style={{ ...S.ctaBtn, padding:'20px 52px', fontSize:'20px', letterSpacing:'-0.3px' }}>
            🎛️ Comenzar gratis
          </button>
        ...
        <div style={{ maxWidth:'1100px', margin:'0 auto' }}>
          <div style={{ textAlign:'center', marginBottom:'60px' }}>
            <h2 style={{ fontSize:'clamp(30px,5vw,54px)', fontWeight:900, lineHeight:1.05, letterSpacing:'-1.5px', marginBottom:'16px' }}>
              4 formas de crear música<br/><span style={GRAD}>con Inteligencia Artificial</span>
            </h2>
            <p style={{ fontSize:'17px', color:T.text2, maxWidth:'520px', margin:'0 auto', lineHeight:1.6 }}>
              Cada modo funciona solo o en combinación. Genera una canción, sepárala en stems y mézclala — todo sin salir de la app.
            </p>
          </div>
          ...
          <div style={{ textAlign:'center', marginTop:'48px' }}>
            ...
            <div style={{ marginTop:'12px', fontSize:'12px', color:T.text3 }}>Sin tarjeta de crédito · $5.99 para 1,000 créditos · nunca vencen</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding:'100px 20px', background:'rgba(10,6,18,0.95)', borderTop:'1px solid rgba(192,38,211,0.15)' }}>
        <div style={{ maxWidth:'1100px', margin:'0 auto' }}>
          ...
          <div style={{ textAlign:'center' }}>
            <button onClick={goRegister} style={{ background:'linear-gradient(135deg,#EC4899,#C026D3,#7C3AED)', border:'none', color:'#fff', padding:'18px 48px', borderRadius:'14px', fontSize:'17px', fontWeight:800, cursor:'pointer', fontFamily:'inherit', boxShadow:'0 0 40px rgba(192,38,211,0.5)', letterSpacing:'-0.3px' }}>
              ✦ Abrir MixingStudio AI gratis
            </button>
            <div style={{ marginTop:'12px', fontSize:'12px', color:T.text3 }}>Sin instalar nada · Funciona en el navegador · 2 canciones gratis</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding:'100px 20px', background:'linear-gradient(135deg,rgba(26,12,46,0.97),rgba(36,18,58,0.95))' }}>
        <div style={{ maxWidth:'960px', margin:'0 auto' }}>
          <div style={{ textAlign:'center', marginBottom:'56px' }}>
            <h2 style={S.sectionTitle}>Simple, sin sorpresas.<br/><span style={GRAD}>Un solo precio para todo.</span></h2>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))', gap:'24px', alignItems:'start' }}>
            ...
            <div style={{ background:'linear-gradient(135deg,rgba(36,18,58,0.98),rgba(20,10,36,0.98))', border:'2px solid #C026D3', borderRadius:'24px', padding:'32px', textAlign:'center', position:'relative', boxShadow:'0 0 48px rgba(192,38,211,0.25)' }}>
              ...
              <div style={{ fontSize:'48px', fontWeight:900, color:T.text, lineHeight:1, marginBottom:'4px' }}>$5.99</div>
              <div style={{ fontSize:'13px', color:'rgba(155,126,200,0.6)', marginBottom:'8px' }}>pago único</div>
          ...
          <div style={{ textAlign:'center', marginTop:'24px', fontSize:'12px', color:T.text3 }}>
            Sin suscripción mensual · Créditos que nunca vencen · SSL seguro · PayPal & Mercado Pago
          </div>
        </div>
      </div>
      ...
      <div style={{ padding:'80px 20px', background:'rgba(15,10,26,0.7)' }}>
        <div style={{ maxWidth:'1100px', margin:'0 auto' }}>
          <div style={{ textAlign:'center', marginBottom:'48px' }}>
            ...
            <p style={{ fontSize:'17px', color:T.text2, maxWidth:'480px', margin:'0 auto', lineHeight:1.6 }}>Sin instalar nada · 2 canciones gratis · $5.99 para 1,000 créditos</p>
          </div>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))', gap:'20px' }}>
            {[
              { num:'1', icon:'🎵', color:'#EC4899', title:'Regístrate y elige tu modo', sub:'Mezclar · Crear · Separar · Instrumentos', desc:'Crea tu cuenta gratis. Tienes 2 canciones completas para explorar los 4 modos — sin tarjeta de crédito.', badge:'Auto-detección IA' },
              { num:'2', icon:'🎛️', color:'#C026D3', title:'Produce con IA', sub:'EQ · Compresor · Efectos · Generación', desc:'Sube stems, escribe un prompt o sube una canción. La IA hace el trabajo pesado: mezcla, genera, separa o agrega instrumentos.', badge:'9 presets de género' },
              { num:'3', icon:'🎚️', color:'#7C3AED', title:'Exporta y publica', sub:'-10 LUFS · WAV 24-bit · MP3', desc:'Descarga en el formato correcto para Spotify, YouTube, Apple Music. El IA EQ garantiza que suene bien en cualquier dispositivo.', badge:'IA EQ 12 bandas' },
            ].map((step,i) => (
          ...
          <div style={{ textAlign:'center', marginTop:'48px' }}>
            ...
            <div style={{ marginTop:'12px', fontSize:'12px', color:T.text3 }}>2 canciones gratis · $5.99 para 1,000 créditos · PayPal & Mercado Pago</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ background:'linear-gradient(135deg,rgba(36,22,54,0.9),rgba(124,58,237,0.15))', borderTop:`1px solid rgba(192,38,211,0.2)`, padding:'100px 20px', textAlign:'center' }}>
        ...
        <p style={{ fontSize:'17px', color:T.text2, marginBottom:'36px', maxWidth:'500px', margin:'0 auto 36px' }}>
          Únete a más de 47,000 músicos que ya producen con IA profesional.<br/>2 canciones gratis · $5.99 para 1,000 créditos.
        </p>
        <button onClick={goRegister} style={{ ...S.ctaBtn, padding:'18px 48px', fontSize:'18px' }}>
          🎛️ Empezar gratis ahora
        </button>
        <div style={{ marginTop:'16px', fontSize:'12px', color:T.text3 }}>Sin tarjeta · Sin suscripción · Créditos que nunca vencen</div>
      </div>
