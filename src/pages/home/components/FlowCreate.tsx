...
export default function FlowCreate({ user, onNavigate, onTrackReady, onCreditsUpdate }: Props) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Si hay audio de referencia y no se escribio letra, indicar que use la letra del audio
      const hasCustomLyrics = !isInstrumental && !autoLyrics && lyrics.trim();
      const finalLyrics = hasCustomLyrics ? lyrics.trim() : undefined;
