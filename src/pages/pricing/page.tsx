...
export default function PricingPage() {
  ...
  return <main className="pricing-v3-page">
    ...
    <section className="pricing-v3-plans">
      ...
      <article className="featured"><b>PRECIO FUNDADOR</b><span>UNLIMITED PARA SIEMPRE</span><h2>Todo el estudio, sin límites</h2><div className="pricing-v3-price"><sup>US$</sup>14.99</div><p>Un solo pago procesado por PayPal.</p>
        ...
        <button onClick={() => navigate(user ? '/checkout-v3' : '/auth/register?mode=checkout')}>Comprar con PayPal →</button>
      </article>
    </section>
    ...
    <section className="pricing-v3-faq"><h2>Antes de comprar</h2><div><article><strong>¿Me cobrarán otra vez?</strong><p>No. US$14.99 es un pago único y no existe renovación automática.</p></article><article><strong>¿Cómo se activa?</strong><p>PayPal confirma el pago y Unlimited queda asociado permanentemente a tu cuenta.</p></article><article><strong>¿Qué pasa con mis archivos?</strong><p>El audio original permanece intacto. Solo procesamos una copia para generar la mezcla o el master.</p></article></div></section>
  </main>;
}
